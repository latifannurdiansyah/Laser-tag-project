...
// Base : V1.5
// Perubahan dari V1.5:
// 1. FIX: Tambah g_irHitPendingTS — flag IR hit persistent
//         supaya ThingSpeak selalu dapat status HIT
//         meski g_ir.got sudah di-reset LoRa task
// 2. FIX: irFlag di sendThingSpeakGprs() pakai g_irHitPendingTS
//         Reset hanya jika ThingSpeak berhasil kirim (ok==true)
// 3. FIX: taskIr set g_irHitPendingTS = true saat HIT
// 4. ThingHTTP body: irStatus tanpa kutip (integer 1/0)
// Semua kode lain TIDAK DIUBAH dari V1.5
// ============================================
...
void setup()
{
  ...
  tft.setCursor(10, 15); tft.print("Heltec Tracker V1.6");
