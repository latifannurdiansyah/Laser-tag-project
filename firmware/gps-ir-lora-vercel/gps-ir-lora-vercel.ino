...
uint64_t devEUI =   0x70B3D57ED00739E0; 
uint64_t joinEUI =  0x0000000000000011;
uint8_t appKey[] = { 0xDB, 0x51, 0xEB, 0x2C, 0x50, 0x13, 0x84, 0x82, 0xE2, 0xFB, 0xD2, 0x64, 0xE7, 0x87, 0x64, 0x27 };
uint8_t nwkKey[] = { 0x84, 0x0E, 0x4C, 0x4C, 0xD0, 0x87, 0xC8, 0x39, 0x56, 0x58, 0x04, 0xE0, 0x39, 0xA7, 0x36, 0x16 };
